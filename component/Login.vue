...
<style scoped>
.login{position: fixed; overflow: hidden;left: 50%; margin-left: -180px; top:50%; margin-top: -350px; width: 500px; min-height: 555px; z-index: 10; right: 140px; background: #fff;-webkit-border-radius: 5px;
